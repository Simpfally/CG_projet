...
class Classifier(nn.Module):
    def __init__(self):
        ...
        # conv2D (kernelsize=5x5, output_channels=6) + maxpool2d(kernel_size=2) + relu
        ...
        # conv2D (kernelsize=5x5, output_channels=16) + maxpool2d(kernel_size=2) + relu
        # linear layer (output_channels = 120) + Relu
        self.lin1 = torch.nn.Linear(in_features=6032, out_features=120)
        # linear layer (output_channels = 60) + Relu
        self.lin2 = torch.nn.Linear(in_features=120, out_features=60)
        # linear layer (output_channels = 1) + Relu
...
def train():
    ...
    for epoch in range(num_epochs):  # loop over the dataset multiple times
        ...
        print("Epoch:",epoch+1,"/",num_epochs, lossy)
        #if epoch % 10 == 9:
